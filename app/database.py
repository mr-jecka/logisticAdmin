            ...
            with conn.cursor() as cursor:
                for th in ths:
                    ...
                    for addr in th["addresses"]:
                        # Use the revers_geocoding_yandex function to get coordinates
                        coordinates = revers_geocoding_yandex(addr["address_delivery"])
                        if coordinates:
                            addr["latitude"], addr["longitude"] = coordinates
                            cursor.execute("""
                                INSERT INTO address_table (num_route, num_shop, code_tt, address_delivery, count_boxes, weight, th_id, latitude, longitude)
                                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s);
                            """, (addr["num_route"], addr["num_shop"], addr["code_tt"], addr["address_delivery"],
                                  addr["count_boxes"],
...
#                     for addr in th["addresses"]:
#                         cursor.execute("""
#                             INSERT INTO address_table (num_route, num_shop, code_tt, address_delivery, count_boxes, weight, th_id)
